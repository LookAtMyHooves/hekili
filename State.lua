...
local mt_toggle = {
    __index = function( t, k )
        ...
        if k == "cooldowns" and ( 
            toggle.override and state.buff.bloodlust.up or 
            toggle.infusion and state.buff.power_infusion.up or 
            toggle.during_boss and state.target.is_boss or 
            toggle.during_trash and UnitClassification( "target" ) == "elite" and state.active_enemies >= 5 and state.time_to_die >= 30 
